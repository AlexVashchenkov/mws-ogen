		...
		case '/': // Prefix: "/user"
			...
			if len(elem) == 0 {
				...
				case "GET":
					...
					r.summary = "Get all Users from the storage"
				...
				case "POST":
					...
					r.summary = "Adding user to the storage"
			...
			case '/': // Prefix: "/"
				...
				if len(elem) == 0 {
					...
					case "DELETE":
						...
						r.summary = "Delete an existing User in storage"
					...
					case "GET":
						...
						r.summary = "Get a User by its ID"
					...
					case "POST":
						...
						r.summary = "Update an existing User in storage"
